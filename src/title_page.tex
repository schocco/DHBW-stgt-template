...
%	\multicolumn{2}{p{\textwidth}}{\textbf{Confidential}}	\\
%	\multicolumn{2}{p{\textwidth}}{The content of the paper must not be made
%	available to third parties without approval of the training company.} \\
  \end{tabular}
\end{center}
\end{table}
