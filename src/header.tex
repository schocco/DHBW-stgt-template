...
\usepackage{setspace}
%options available: \singlespacing , \onehalfspacing , \doublespacing
\onehalfspacing
...
% Default fonts
\renewcommand{\rmdefault}{phv} %phv = Adobe Helvetica 
\renewcommand{\sfdefault}{phv} %phv = Adobe Helvetica 
