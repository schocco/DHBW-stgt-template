...
% table with entry type my appendix
%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\appsection}[1]{%
	\subsection{#1}\addtoappendixlist{#1}}
...
% package used for the page headers:
%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{scrpage2}
...
% define the layout margins
%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[paper=a4paper,left=35mm,right=15mm,top=25mm,bottom=20mm]{geometry}

% define the spacing of the footnotes
%%%%%%%%%%%%%%%%%%%%%%%
\deffootnote{10pt}{10pt}{\textsuperscript{\thefootnotemark\ }}

% declaring the depth (section, subsection, subsubsection ) for which headings will be displayed
% (visibility in the TOC / numbering)
%%%%%%%%%%%%%%%%%%%%%%%
